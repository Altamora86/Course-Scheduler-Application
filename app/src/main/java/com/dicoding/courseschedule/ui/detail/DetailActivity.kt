...
class DetailActivity : AppCompatActivity() {
    ...
    private fun showCourseDetail(course: Course?) {
        val tvCourse: TextView = findViewById(R.id.tv_course_name)
        val tvTime: TextView = findViewById(R.id.tv_time_detail)
        val tvLecturer: TextView = findViewById(R.id.tv_lecturer_detail)
        val tvNote: TextView = findViewById(R.id.tv_note_detail)
        course?.apply {
            ...
            tvNote.text = note
            Log.e("kiwkiw", "showCourseDetail: ${tvNote.text}", )
        }
    }
